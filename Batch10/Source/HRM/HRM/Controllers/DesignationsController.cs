...
namespace HRM.Controllers
{
    public class DesignationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,DeptId,CreateDate")] Designation designation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,DeptId,CreateDate")] Designation designation)
        {
            if (ModelState.IsValid)
            {
